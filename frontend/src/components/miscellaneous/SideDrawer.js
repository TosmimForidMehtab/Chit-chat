...
const SideDrawer = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            toast({
                title: "Error occured while searching for users",
                status: "error",
                duration: 5000,
                isClosable: true,
    ...
    return (
        <>
            <Box display={"flex"} justifyContent="space-between" alignItems={"center"} bg="white" width={"100%"} padding="5px 10px 5px 10px" borderWidth={"5px"}>
                ...
                <div>
                    <Menu>
                        <MenuButton padding={1}>
                            <NotificationBadge count={notification.length} effect={Effect.ROTATE_Y} />
