...
const UpdateGroupChatModal = ({ fetchAgain, setFetchAgain, fecthMessages }) => {
                ...
                <ModalContent>
                    ...
                    <ModalBody display={"flex"} flexDir="column" alignItems="center">
                        ...
                        <FormControl display={"flex"}>
                            ...
                            <Button variant="solid" colorScheme="green" ml={1} isLoading={renameloading} onClick={handleRename}>
                                Update
                            </Button>
                        </FormControl>
                        <FormControl>
